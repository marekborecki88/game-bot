...
from src.config.config import Config, Strategy as StrategyType
...
def choose_strategy(config: Config) -> Strategy:
...
class LogicEngine:
    ...
    def __init__(self, config: Config, game_state: GameState | None = None):
        ...
        self.strategy = choose_strategy(config)
